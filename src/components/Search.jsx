...
const Search = (props) => {
    ...
    const handleSubmit = (evt) => {
        ...
        axios.post("http://localhost:5000/protein", content).then(e => {
            let query = `MATCH (prot0: Prot{entry:  "${protName}" })-[r1:SIMI]-(prot1) MATCH (prot1)-[r2:SIMI]-(prot2) WHERE r1.value[0] >= ${threshold} AND r2.value[0] >= ${threshold} RETURN prot0,prot1,prot2,r1,r2 LIMIT ${toDisplay}`;
